...
Before training the model on the training data set, we must split it into training and validation data sets. The validation set will allow us to test the accuracy of the model on unseen data.
